...
def main():
    ...
    while True:  # Main game loop.
        ...
        while True:  # Keep looping until player stands or busts.
            ...
            if move in ('S', 'D'):
                # Stand/douling down stops the player's turn.
                break
...
def displayHands(playerHand, dealerHand, showDealerHand):
    """Show thw player's and dealer's cards. Hide the dealer's first card if showDealerHand is False."""
    print()
    if showDealerHand:
...
# If the program ir run (inteads of imported), run the game:
